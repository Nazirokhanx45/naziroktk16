...
"""%s
 ...
 - author      : TOOR AJMAL &NAZIRO KHANX
 - facebook    : https://www.facebook.com/NaZerkhaN521
 - fanspage    : https://www.facebook.com/NaZerkhaN521
 - whatsap     : +92302........
 - github      : github.com/NAZIR5
 - script name : ZAFI (NAZIRO KHANX )
 - version     : 1.1
...
def banner():
	print (''' %s 
 © Group%s \n __________       _____.__  \n \____    /____ _/ ____\__| %s> %sNAZIRO \n   /     /\\__  \\\   __\|  | %s> %sTOOR \n  /     /_ / __ \|  |  |  | %s>%s Facebook [Meta] \n /_______ (____  /__|  |__| %s>%s PAKISTAN \n         \/    \/ \n %s[%s*%s] By : %sNAZIRO \n %s[%s*%s] -------------------------------------- \n [%s*%s] IP : %s%s'''%
